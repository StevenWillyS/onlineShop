				...
				<div class="col-md-12">
					...
					<div class="col-md-6" style="padding-left: 2em; line-height: 2em;" >
						...
						<div class="form-group">
							...
							<input class="form-control" name="alamat" placeholder="Masukan Alamat Anda" type="text" />
							<label for="email">Email</label>
							<input class="form-control" name="email" placeholder="Masukan Alamat Email Anda" type="text"  />
